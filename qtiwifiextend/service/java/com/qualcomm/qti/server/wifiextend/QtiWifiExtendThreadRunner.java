 ...
 */
public class QtiWifiExtendThreadRunner {
    private static final String TAG = "QtiWifiExtendThreadRunner";

    /** Max wait time for posting blocking runnables */
    private static final int RUN_WITH_SCISSORS_TIMEOUT_MILLIS = 4000;
    private final Handler handler;

    public QtiWifiExtendThreadRunner(Handler h) {
        handler = h;
    }
    ...
    public <T> T call(@NonNull Supplier<T> supplier, T valueToReturnOnTimeout) {
        ...
        if (runWithScissorsSuccess) {
            ...
            Log.e(TAG, "QtiWifiExtendThreadRunner.call() timed out!", callerThreadThrowable);
            Log.e(TAG, "QtiWifiExtendThreadRunner.call() timed out!", qtiwifiThreadThrowable);
            throw new RuntimeException("QtiWifiExtendThreadRunner.call() timed out!");
        }
    }
