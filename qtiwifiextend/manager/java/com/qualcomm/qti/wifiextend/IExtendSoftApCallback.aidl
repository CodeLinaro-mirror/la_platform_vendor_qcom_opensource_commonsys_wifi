...
interface IExtendSoftApCallback {
    oneway void onStateChanged(int state, int failureReason);
    oneway void onConnectedClientsChanged(in WifiClient client,
                      boolean isConnected, int disconectReason);
    oneway void onInfoChanged(in List<SoftApInfo> softApInfoList);
}
