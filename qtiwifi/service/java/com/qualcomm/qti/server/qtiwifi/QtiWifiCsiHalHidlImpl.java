...
public class QtiWifiCsiHalHidlImpl implements IQtiWifiCsiHal {
    private static final String TAG = "QtiWifiCsiHalHidlImpl";
    ...
    public static boolean serviceDeclared() {
        try {
            ...
            String interfaceName = vendor.qti.hardware.wifi.wificfr.V1_0.IWificfr.kInterfaceName;
